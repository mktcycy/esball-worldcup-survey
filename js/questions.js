...
(function () {
  ...
  var member = {
    start: "m1",
    intro: "亲爱的会员您好，恭喜您获得隐藏问卷活动的参与资格！您只需花 3 分钟填写问卷，即可随机获得 8-1888 奖金（内容越完整，获得高额奖金的机率越高）。",
    questions: {
  ...
  var newbie = {
    start: "n1",
    intro: "您好，感谢填写新人问卷！完成即有机会免费抽 ¥88,888 红包。全程匿名，敬请安心作答。",
    questions: {
  ...
  var landings = {
    ...
    L_ref: {
      kind: "referral",
      title: "📢 填码分享问卷，最高抽 ¥88,888 红包！",
      lead: "想赚取更多回馈？简单两步骤，轻松把最高 ¥88,888 奖金带回家！",
      steps: [
        { h: "📥 第一步：填写并复制链接",
          items: ["填写推荐码：于下方输入您的【会员推荐码】", "不知如何查看？请至「会员中心 > 会员推荐码」查询", "复制专属链接：点击下方【复制问卷链接】按钮"] },
        { h: "🎁 第二步：好友相挺，好礼双重送",
