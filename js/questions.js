...
(function () {
  ...
  var newbie = {
    start: "n1",
    bonus: "🧧 最高奖金 ¥88,888 红包等你领",
    intro: "您好，完成这份问卷，完成注册与投注，即有机会免费抽奖。全程匿名，敬请安心作答。",
    questions: {
      n1: { type: "text", q: "您平时都在哪个网站下注呢？", placeholder: "请填写网址", next: "n2" },
      n2: {
        type: "multi", max: 3, q: "您为何会选择该网站进行投注呢？（最多选择 3 项）",
        options: [
  ...
  var landings = {
    ...
    L_ref: {
      ...
      steps: [
        ...
        { h: "🎁 第二步：好友相挺，好礼双重送",
          items: ["当好友完成：填写问卷 ＋ 注册 ＋ 投注达 888", "第一重｜原有流水推荐金 XX% 照样领！", "第二重｜8/18–8/31 期间，获得免费抽 ¥88,888 红包资格！", "（推荐越多好友，抽中大奖机率越高）"] }
      ],
      highlights: ["🏆 百万奖金：红包最高可抽中 ¥88,888 转运金", "📈 无上限抽：成功推荐 1 位就送 1 次抽奖机会，次数无上限！"],
      note: "（红包链接将于会员派彩讯息提供专属链接，转传无效）"
    },
    L_reg: {
      kind: "register",
      title: "❤️ 感谢您的问卷填写！",
